defmodule LiveviewUploadsRedirectIssueWeb.ImageLiveTest do
  use LiveviewUploadsRedirectIssueWeb.ConnCase

  import Phoenix.LiveViewTest
  import LiveviewUploadsRedirectIssue.CatalogFixtures

  @create_attrs %{image_upload: "some image_upload", name: "some name"}
  ...
  describe "Index" do
    ...
    test "lists all images", %{conn: conn, image: image} do
      ...
      assert html =~ image.image_upload
    end
    ...
    test "updates image in listing", %{conn: conn, image: image} do
      ...
      assert html =~ "some updated image_upload"
    end
